...
def upload_to_nextcloud(encrypted_file_path):
    ...
    nextcloud_user = "Tester2:@Secret5858"  # Replace with your username:password
    nextcloud_folder_url = "https://aimancloud.online/remote.php/webdav/My%20Tester%20Folder/"  # Replace with your Nextcloud folder URL
